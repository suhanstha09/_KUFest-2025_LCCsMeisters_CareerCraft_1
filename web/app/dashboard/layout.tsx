    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors">
      ...
      <div className="flex">
        ...
        <aside
          ...
          } lg:translate-x-0 fixed lg:relative h-screen w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 pt-6 transition-transform duration-300 z-30 overflow-y-auto`}
        >
          ...
          <div className="mt-8 px-4 pt-6 border-t border-slate-200 dark:border-slate-800">
            <Link
              href="/dashboard/dream-job"
              className="w-full flex items-center justify-between px-4 py-3 rounded-lg text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition font-medium"
            >
              <div className="flex items-center gap-3">
